...
ErrorState LCD_EnuSendData(u8 Copy_U8Data)
{
	...
	MGPIO_EnuSetPinVal(LCD_RS,HIGH) ;  	 // RS = 1  -> Send Data
...
ErrorState LCD_EnuSendCommand(u8 Copy_U8Command)
{
	...
	MGPIO_EnuSetPinVal(LCD_RS,LOW) ;   	// RS = 0  -> Send Command
...
{
	MGPIO_EnuSetPinVal(LCD_RW,LOW) ;	  	 // R/W =0  -> Write this data
	...
	MGPIO_EnuSetPinVal ( LCD_D0 , ( Copy_U8Value  >> BIT0 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D1 , ( Copy_U8Value  >> BIT1 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D2 , ( Copy_U8Value  >> BIT2 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D3 , ( Copy_U8Value  >> BIT3 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D4 , ( Copy_U8Value  >> BIT4 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D5 , ( Copy_U8Value  >> BIT5 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D6 , ( Copy_U8Value  >> BIT6 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D7 , ( Copy_U8Value  >> BIT7 ) & 1  ) ;

	MGPIO_EnuSetPinVal(LCD_EN,HIGH) ;   	 // EN = 1
	_delay_ms(1) ;

	MGPIO_EnuSetPinVal(LCD_EN,LOW) ;   	 // EN = 0
	_delay_ms(1) ;
	...
	for (u8 i=0;i<=n;i++)
	{
		...
		MGPIO_EnuSetPinVal ( LCD_D5 , ( Copy_U8Value  >> BIT5 ) & 1  ) ;
		MGPIO_EnuSetPinVal ( LCD_D6 , ( Copy_U8Value  >> BIT6 ) & 1  ) ;
		MGPIO_EnuSetPinVal ( LCD_D7 , ( Copy_U8Value  >> BIT7 ) & 1  ) ;  	 // MSB (Most significant 4 bits)
	...
	MGPIO_EnuSetPinVal ( LCD_D4 , ( Copy_U8Value  >> BIT0 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D5 , ( Copy_U8Value  >> BIT1 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D6 , ( Copy_U8Value  >> BIT2 ) & 1  ) ;
	MGPIO_EnuSetPinVal ( LCD_D7 , ( Copy_U8Value  >> BIT3 ) & 1  ) ; 		// LSB Data  (Least significant 4 bits)
...
/*---------------------------------*/
	...
	MGPIO_EnuSetPinDir ( LCD_D0 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D1 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D2 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D3 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D4 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D5 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D6 , OUTPUT_10MHZ_PP  ) ;
	MGPIO_EnuSetPinDir ( LCD_D7 , OUTPUT_10MHZ_PP  ) ;


	// Set Control Pins With Direction
	MGPIO_EnuSetPinDir( LCD_RS , OUTPUT_10MHZ_PP );
	MGPIO_EnuSetPinDir( LCD_RW , OUTPUT_10MHZ_PP );
	MGPIO_EnuSetPinDir( LCD_EN , OUTPUT_10MHZ_PP );
...
/*---------------------------------*/
	...
	// Set Control Pins With Direction
	MGPIO_EnuSetPinDir( LCD_RS , OUTPUT );
	MGPIO_EnuSetPinDir( LCD_RW , OUTPUT );
	MGPIO_EnuSetPinDir( LCD_EN , OUTPUT );

	// Set Data Pins with Direction
	MGPIO_EnuSetPinDir ( LCD_D4 , OUTPUT  ) ;
	MGPIO_EnuSetPinDir ( LCD_D5 , OUTPUT  ) ;
	MGPIO_EnuSetPinDir ( LCD_D6 , OUTPUT  ) ;
	MGPIO_EnuSetPinDir ( LCD_D7 , OUTPUT  ) ;
